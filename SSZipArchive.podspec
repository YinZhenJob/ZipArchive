Pod::Spec.new do |s|
  s.name         = 'SSZipArchive'
  s.version      = '1.1.2'
  s.summary      = 'Utility class for zipping and unzipping files on iOS, tvOS, visionOS, watchOS, and macOS. Add cancel action.'
  ...
  s.homepage     = 'https://github.com/YinZhenJob/ZipArchive'
  s.license      = { :type => 'MIT', :file => 'LICENSE.txt' }
  s.authors      = { 'Sam Soffes' => 'sam@soff.es', 'Joshua Hudson' => nil, 'Wilson Chen' => nil }
  s.source       = { :git => 'https://github.com/YinZhenJob/ZipArchive.git', :tag => "#{s.version}" }
